            ...
            <div class="card">
                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input placeholder='Input disini...' type="text" class="form-control" id="inputNama" >
                    </div>

                    <div class="mb-3">
                        <label for="inputUsername" class="form-label">Username</label>
                        <input placeholder='Input disini...' type="text" class="form-control" id="inputUsername" >
                    </div>

                    <div class="mb-3">
                        <label for="inputPassword" class="form-label">Password</label>
                        <input placeholder='Input disini...' type="password" class="form-control" id="inputPassword" >
                    </div>
